...
import { editExpense } from '../ExpenseReducer'
import { useDispatch, useSelector } from 'react-redux'
import { useState } from 'react'
import { useNavigate, useParams } from 'react-router-dom'

function EditExpense({prefill, onClose}) {
    ...
    <>
      <div className="isolate bg-white px-6 py-24 sm:py-15 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Update Your Expense</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl sm:mt-20">
           ...
           <div className='sm:col-span-2 pt-7'>
            ...
            <div className="mt-10">
              <button type="submit" className="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit Expense</button>
            </div>
          </form>
        </div>
    </>
